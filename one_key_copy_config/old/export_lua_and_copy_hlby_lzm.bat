...
set doc_dir=G:\JYHD\HuanLe_doc

:: tools的路径
set tools_dir=G:\JYHD\JyQipai_tools

:: 导出py脚本
set py_sprite=e2l_HuanLe_doc_lzm.py

:: 服务器 文件夹路径
set server_dir_name_1=G:\JYHD\HuanLe_server_1\skynet\game\config
set server_dir_name_2=G:\JYHD\HuanLe_server_2\skynet\game\config
