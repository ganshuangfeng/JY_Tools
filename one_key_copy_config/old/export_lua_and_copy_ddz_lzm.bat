...
set doc_dir=G:\JYHD\JyQipai_doc
...
:: 服务器 文件夹路径
set server_dir_name_1=G:\JYHD\JyQipai_server_dev_1\skynet\game\config
set server_dir_name_2=G:\JYHD\JyQipai_server_dev_2\skynet\game\config
