...
set doc_dir=D:\jyddz_webgame\jyddz_webgame_doc
...
:: 服务器 文件夹路径
set server_dir_name_1=D:\jyddz_webgame\jyddz_web_server\skynet\game\config
set server_dir_name_2=D:\jyddz_webgame\export_lua_temp
...
%tools_dir%\Python27\python.exe %tools_dir%\script\excel2lua\%py_sprite% 3
