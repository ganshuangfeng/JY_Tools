...
set doc_dir=E:\GIT\HuanLe_doc

:: tools的路径
set tools_dir=E:\GIT\JyQipai_tools

:: 导出py脚本
set py_sprite=e2l_HuanLe_doc_yy.py

:: 服务器 文件夹路径
set server_dir_name_1=E:\GIT\HuanLe_server\skynet\game\config
set server_dir_name_2=E:\GIT\HuanLe_server_1\skynet\game\config
