...
set doc_dir=D:\JYHD\JyQipai_doc
...
:: 服务器 文件夹路径
set server_dir_name_1=D:\JYHD\JyQipai_server_dev\skynet\game\config
set server_dir_name_2=D:\JYHD\export_lua_temp
...
%tools_dir%\Python27\python.exe %tools_dir%\script\excel2lua\%py_sprite% 1
