...
set doc_dir=E:\GIT\JyQipai_doc

:: tools的路径
set tools_dir=E:\GIT\JyQipai_tools

:: 导出py脚本
set py_sprite=e2l_JyQipai_doc_yy.py

:: 服务器 文件夹路径
set server_dir_name_1=E:\GIT\JyQipai_server_dev\skynet\game\config
set server_dir_name_2=E:\GIT\JyQipai_server_dev_copy\skynet\game\config
