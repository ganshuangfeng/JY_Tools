...
:: 服务器 文件夹路径
set server_dir_name_1=E:\JYHD\HuanLe_server\skynet\game\config
set server_dir_name_2=E:\JYHD\HuanLe_server1\skynet\game\config
