...
set doc_dir=D:\temp_HuanLe_temp\HuanLe_doc_temp

:: tools的路径
set tools_dir=D:\JYHD\JyQipai_tools

:: 导出py脚本
set py_sprite=e2l_cf.py

:: 服务器 文件夹路径
set server_dir_name_1=D:\temp_HuanLe_temp\HuanLe_server_temp\skynet\game\config
set server_dir_name_2=D:\temp_HuanLe_temp\export_lua_temp

:: 客户端 文件夹路径
:: set client_dir_name_1=G:\JYHD\HuanLe_server_1\skynet\game\config
...
%tools_dir%\Python27\python.exe %tools_dir%\script\excel2lua\%py_sprite% 4
