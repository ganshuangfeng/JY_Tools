...
set doc_dir=D:\HuanLe\HuanLe_doc
...
:: 服务器 文件夹路径
set server_dir_name_1=D:\HuanLe\HuanLe_server\skynet\game\config
set server_dir_name_2=D:\HuanLe\export_lua_temp
...
%tools_dir%\Python27\python.exe %tools_dir%\script\excel2lua\%py_sprite% 2
